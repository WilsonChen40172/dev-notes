  ...
  return (
    <div className="flex flex-col gap-12">
      <header className="text-center py-10">
        ...
        <p className="text-neutral-500 dark:text-neutral-400 text-xl max-w-2xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {topics.map((topic) => (
          <Link
            key={topic.title}
            href={topic.href}
            className="group relative overflow-hidden rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900/50 p-8 transition-all hover:border-neutral-400 dark:hover:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-800 hover:shadow-lg hover:shadow-neutral-200/50 dark:hover:shadow-neutral-900/50"
          >
            ...
            <h2 className="text-2xl font-bold mb-3 text-neutral-900 dark:text-neutral-100 group-hover:text-neutral-700 dark:group-hover:text-white relative z-10">
              {topic.title}
            </h2>
            <p className="text-neutral-600 dark:text-neutral-400 group-hover:text-neutral-700 dark:group-hover:text-neutral-300 relative z-10">
              {topic.description}
            </p>
          </Link>
        ))}
      ...
      {/* About / Profile 區塊 */}
      <section className="rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900/50 p-8 flex flex-col gap-6">
        <div className="flex flex-col sm:flex-row sm:items-center gap-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-neutral-900 dark:text-neutral-100">Wilson Chen</h2>
            <p className="text-neutral-500 dark:text-neutral-400 text-sm mt-1">Frontend Developer</p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          {skills.map((skill) => (
            <span
              key={skill}
              className="px-3 py-1 text-xs font-medium rounded-full bg-neutral-100 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 border border-neutral-200 dark:border-neutral-700"
            >
              {skill}
            </span>
          ))}
